...
Các hình dưới đây được lấy từ output thật trong thư mục \code{figures\_overlay}. Mỗi hình gồm ảnh đầu vào, ground truth mask, predicted mask và overlay, giúp quan sát trực quan các trường hợp dự đoán đúng hoặc sai thay vì chỉ dựa vào metric.
